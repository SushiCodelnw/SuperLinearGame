...
function updateBackground(background) {
  ...
  if (background) {
    backgroundImg.style.backgroundImage = `url("./MorphoPaws/assets/images/Backgrounds/${background}.png")`;
  }
}
...
function updateCharacter(character) {
  ...
  if (character) {
    characterImg.style.backgroundImage = `url("./MorphoPaws/assets/images/Characters/${character}.png")`;
  }
}
